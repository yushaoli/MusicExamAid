...
## B) Core user journeys (Parent / Teacher)

### B1 Parent journey: profile → registration → teacher review
...
### **B2 Parent journey: 国音 query → save to archive**
...
erDiagram
    ...
    TeacherAccount ||--o{ MusicClass : manages
    
    MusicClass ||--o{ ClassEnrollment : has
...
## D) Registration status state machine
